...
export const VentasServices = {
    ...
    try {
        ...
        const url = `/api/negocio/${this.idNegocio}/venta/${this.nombreUsuario}`;
    ...
    async consultarProductoPorCodigo(codigoProducto) {
        try {
            const url = `/api/negocio/${this.idNegocio}/venta/lote/${codigoProducto}`;
    ...
    async guardarDetallesVenta(listaDetalles) {
        try {
            const url = `/api/negocio/venta/detalles`;
            const res = await fetch(url, {
                method: "POST",
    ...
    async cancelarVenta() {
        try {
            const url = `/api/negocio/${this.idNegocio}/venta`;
    ...
    async obtenerTotalVenta() {
        try {
            const url = `/api/negocio/${this.idNegocio}/venta/total`;
            const res = await fetch(url);
