...
export function inicializarCorteCaja() {
    ...
    document.getElementById('formAbrirCaja').onsubmit = async function (e) {
        ...
        try {
            // POST para abrir caja
            const resPost = await fetch(`https://clinkapp.zapto.org:8080/negocio/${idNegocio}/corteCaja/${nombreUsuario}`, {
                method: "POST",
...
async function obtenerDatosCorteCajaActivo() {
    ...
    try {
        const resGet = await fetch(`https://clinkapp.zapto.org:8080/negocio/${idNegocio}/corteCaja`);
