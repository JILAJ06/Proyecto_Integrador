...
// ...existing code...
    ...
    async function cargarClientesEnCombobox(combobox) {
        try {
            ...
            const url = `/api/negocio/${negocioId}/clientes`;
    ...
    async function enviarTicketPorSms(clienteId) {
        ...
        try {
            ...
            const generarResponse = await fetch(`/api/negocio/${negocioId}/ticket`, {
                method: 'POST'
            });
            ...
            const enviarResponse = await fetch(`/api/negocio/${negocioId}/ticket/send/${clienteId}`, {
                method: 'GET'
            });
